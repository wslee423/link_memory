...
- [x] Empty state UI
- [x] 전체 플로우 QA
- [x] 프로덕션 배포 (Vercel) — 2026-04-15

## Milestone 2 — Post-MVP

### P1 (완료)
- [x] 링크 삭제 UI — 2026-04-15
- [x] 텍스트 검색 (제목/URL 필터) — 2026-04-15
- [x] 링크 보관(Archive) + 보관함 토글 — 2026-04-15
- [x] 북마클릿 (/save 팝업) — 2026-04-15

### P1 (완료)
- [x] 태그 관리 (태그 삭제/이름 변경)

### P1 (완료)
- [x] 비밀번호 재설정 플로우 (`/auth/callback`, `/reset-password`) — 2026-04-23
